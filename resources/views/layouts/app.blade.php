...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:site_name" content="{{ $about_me->getTranslate('name') }}">
        ...
        <title>{{ $about_me->getTranslate('name') }} | @yield('title')</title>
    ...
    <body class="oh">
        ...
        @yield('scripts')
        <footer>
           Copyright © <a href="#">{{ $about_me->getTranslate('name') }}</a>
        </footer>
