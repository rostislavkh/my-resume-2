...
$('input[name="search"]').focus(function () {
  var resultMenu = this.parentElement.querySelector('.result-search');
...
$('input[name="search"]').on('keyup ', function () {
  ...
  var resultMenu = this.parentElement.querySelector('.result-search');
  var list = resultMenu.querySelector('.list');
  var loader = resultMenu.querySelector('.loading');
  ...
  if (this.value != "") {
    timeout = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data, _i, _Object$entries, _Object$entries$_i, key, _value, _i2, _Object$entries2, _Object$entries2$_i, _key, _value2;
          ...
          case 3:
            if (data) {
              ...
              if (data.projects.length != 0) {
                ...
                for (_i = 0, _Object$entries = Object.entries(data.projects); _i < _Object$entries.length; _i++) {
                  _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), key = _Object$entries$_i[0], _value = _Object$entries$_i[1];
                  list.innerHTML += "<li class=\"proj\">\n                            <a href=\"".concat(data.projects[key].url, "\">\n                                <img src=\"").concat(data.projects[key].img, "\" alt=\"img\">\n                                <div class=\"proj__info\">\n                                    <h4 class=\"name\">").concat(data.projects[key].name, "</h4>\n                                    <div class=\"desc\">").concat(data.projects[key].short_desc, "</div>\n                                </div>\n                            </a>\n                        </li>");
                }
              }
              if (data.tags.length != 0) {
                list.innerHTML += " <li class=\"label\">".concat(data.label_2, "</li>");
                for (_i2 = 0, _Object$entries2 = Object.entries(data.tags); _i2 < _Object$entries2.length; _i2++) {
                  _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2), _key = _Object$entries2$_i[0], _value2 = _Object$entries2$_i[1];
                  list.innerHTML += "<li class=\"tag\"><a href=\"".concat(data.tags[_key].url, "\">#").concat(data.tags[_key].tag, "</a></li>");
                }
              }
            }
